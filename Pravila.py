...
class App(QMainWindow):
    def __init__(self):
        ...
        self.pushButton_6.clicked.connect(self.image4)
        self.pushButton_7.clicked.connect(self.image5)
        self.pushButton_4.clicked.connect(self.image6)
        self.label.hide()
        self.label_2.hide()
        self.label_3.hide()
        self.label_4.hide()
    ...
    def image1(self):
        ...
        self.label.show()
        self.label_7.setPixmap(QPixmap("stop.png"))
        self.label_7.show()
