...
class Main2(Screen):
    def __init__(self,**kwargs):
        super().__init__(**kwargs)
        label2 = Label(text = inst2, size_hint=(1,0.5), pos_hint={"y":0.5, "center_x": 0.5})
        label3 = Label(text = "Введіть результат", size_hint=(0.2,0.05), pos_hint={"y":0.17, "center_x": 0.1})
        rezult = TextInput(multiline=False, size_hint=(0.35,0.05), pos_hint={"y":0.17, "center_x": 0.5})
...
class Main3(Screen):
    def __init__(self,**kwargs):
        super().__init__(**kwargs)
        label4 = Label(text = inst2, size_hint=(1,0.5), pos_hint={"y":0.5, "center_x": 0.5})
...
class Win(App):
    def build(self):
        ...
        main_screen.add_widget(Main2(name='main3'))
        return main_screen
